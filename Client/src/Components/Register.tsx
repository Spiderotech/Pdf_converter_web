...
const Register = () => {
    ...
    const handleGoogleLoginSuccess = async (response) => {
        ...
        const data = { email: userData.email,fullName:userData.name};

        try {
            const response = await axios.post('/googlecreateuser', data);
                ...
                <div className="w-full max-w-md space-y-6 text-gray-600">
                    <div className="text-center">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p>Already have an account? <a href="/login" className="font-medium text-indigo-600 hover:text-indigo-500">Log in</a></p>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div>
                                ...
                                <input
                                    type="text"
                                    {...register('name')}
                                    className={`w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border ${errors.name ? 'border-red-500' : 'focus:border-indigo-600'} shadow-sm rounded-lg`}
                                />
