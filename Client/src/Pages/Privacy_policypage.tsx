...
const sections: LegalSection[] = [
  ...
  { title: 'Third-Party Services', text: 'We may use hosting providers, MongoDB services, Google OAuth, Aspose Cloud conversion services, and similar infrastructure providers to operate the app. Files sent to tools that rely on Aspose Cloud may be transmitted to Aspose for conversion. We do not sell uploaded documents.', icon: FiGlobe },
